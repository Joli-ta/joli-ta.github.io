...
[Newer post about the Eject key assignments]({% link /docs/2023-06-17-eject.md %}) - human interface device (HID) utility for modifying the regular keyboard keys as well as the consumer one shot control (OSC) keys.

[How else to make my keyboard my own]({% link /docs/2023-06-14-keys.md %}) - user key bindings.
