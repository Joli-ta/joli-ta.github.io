...
<dl>
<dt>💡Update </dt>
<dd>Please check the [newer post] with a version 2 of a script that does it all.</dd>
</dl>

💡Update
 : Please check the [newer post] with a version 2 of a script that does it all.
